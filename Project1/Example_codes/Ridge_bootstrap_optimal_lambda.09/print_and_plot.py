...
N10 = np.loadtxt("Files/e_N10.txt", skiprows=1)
test10  = N10[:,0]
train10 = N10[:,1]

N20 = np.loadtxt("Files/e_N20.txt", skiprows=1)
test20  = N20[:,0]
train20 = N20[:,1]

N30 = np.loadtxt("Files/e_N30.txt", skiprows=1)
test30  = N30[:,0]
train30 = N30[:,1]
...
axs[0].legend(loc="upper right")
axs[0].set_title(r"MSE for test and train datasets"+"\n"+ "for different number of data points, LASSO, bootstrap", fontsize=12)
